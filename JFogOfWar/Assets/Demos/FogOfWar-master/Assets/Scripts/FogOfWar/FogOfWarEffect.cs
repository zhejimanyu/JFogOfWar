/*
原文链接：http://www.lsngo.net/2017/11/04/unity_fovfogofwar/?yoxurg=gmwwn3
*/
...
public class FogOfWarEffect : MonoBehaviour
{
    ...
    {
        return new Vector2(m_XSize / m_TexWidth, m_ZSize / m_TexHeight);
    }

    public Vector2 GetInvDelta()
    {
        Vector2 delta = GetDelta();
        return new Vector2(1.0f / delta.x, 1.0f / delta.y);
    }
